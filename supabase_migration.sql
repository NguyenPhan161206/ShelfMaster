-- ==========================================
-- SELFMASTER CUSTOM DATABASE MIGRATION (NO SUPABASE AUTH)
-- Đảm bảo tính Idempotent: Có thể chạy lại nhiều lần
-- ==========================================

-- 0. DỌN DẸP TRƯỚC KHI TẠO (Nếu đã tồn tại)
drop trigger if exists on_auth_user_created on auth.users;
drop function if exists public.handle_new_user();

-- 1. Bảng Users (Tự quản lý thay thế cho auth.users)
...
-- 8. TẮT RLS ĐỂ QUẢN LÝ DỮ LIỆU QUA APP LOGIC
